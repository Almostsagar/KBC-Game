...
int main()
    ...
    printf("\n -------------------------------------------------------------------------");
    printf("\n >> There are 2 rounds in this Quiz Game, STARTER ROUND & CHALLENGE ROUND");
    printf("\n >> In Starter round you will be asked a total of 3 questions to test your");
    ...
    printf("\n    total of 10 questions. Each correct answer will be awarded Rs.1,00,000!");
...
void help()
    ...
    printf("\n\n\tMAY THE ODDS BE IN YOUR FAVOUR");
	printf("\n\n\t*********************BEST OF LUCK*********************************");
	printf("\n\n\t*****KAUN BANEGA CROREPATI is developed by Sagar Kumar********");}
